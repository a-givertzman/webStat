...
/**
 * Класс   | Виджет, показывающий список сайтов, страниц и html элементов
 * WebStat | по которым есть статистика кликов, строится на основе
 *         | дерева пути к месту клика из БД
 */
class WebStat {
    ...
    protected function run() {
        ...
        // To Do: Включить кэш виджета WebStat
